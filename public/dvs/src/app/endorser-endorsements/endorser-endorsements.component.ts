...
@Component({
  selector: 'app-endorser-endorsements',
  templateUrl: './endorser-endorsements.component.html',
  styleUrls: ['./endorser-endorsements.component.css']
})
export class EndorserEndorsementsComponent implements OnInit {
  ...
  getEndorsements(): void {
    ...
    this.authService.getAllEndorsements().subscribe(results => {
