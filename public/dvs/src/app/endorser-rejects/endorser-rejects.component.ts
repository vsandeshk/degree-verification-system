...
@Component({
  selector: 'app-endorser-rejects',
  templateUrl: './endorser-rejects.component.html',
  styleUrls: ['./endorser-rejects.component.css']
})
export class EndorserRejectsComponent implements OnInit {
  ...
  getRejects(): void {
    ...
    this.authService.getAllRejects().subscribe(results => {
