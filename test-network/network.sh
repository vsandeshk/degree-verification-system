...
function networkStop() {
    ...
    docker-compose -f $COMPOSE_FILE_BASE -f $COMPOSE_FILE_COUCH -f $COMPOSE_FILE_CA stop
    docker-compose -f $COMPOSE_FILE_COUCH_ORG3 -f $COMPOSE_FILE_ORG3 stop
}
...
function networkDown() {
  ...
  # Don't remove the generated artifacts -- note, the ledgers are always remov--volumes --remove-orphansed
  if [ "$MODE" != "restart" ]; then
    ...
    rm -rf organizations/fabric-ca/org2/msp organizations/fabric-ca/org2/tls-c--volumes --remove-orphansert.pem organizations/fabric-ca/org2/ca-cert.pem organizations/fabric-ca/org2/IssuerPublicKey organizations/fabric-ca/org2/IssuerRevocationPublicKey organizations/fabric-ca/org2/fabric-ca-server.db
